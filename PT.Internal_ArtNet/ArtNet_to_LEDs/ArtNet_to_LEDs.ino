...
// Artnet settings
Artnet artnet;
const int startUniverse = 100;  // CHANGE FOR YOUR SETUP most software this is 1, some software send out artnet first universe as 0.

// Check if we got all universes
const int maxUniverses = startUniverse + numberOfChannels / 512 + ((numberOfChannels % 512) ? 1 : 0);
